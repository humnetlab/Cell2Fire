 ...
 */
void
Cell2Fire::reset(int rnumber, double rnumber2, int mcnumber, int simExt = 1)
{
    // Reset info
    ...
    if ((this->args.OutIntensity) && (this->args.AllowCROS) && (this->args.Simulator == "S" || this->args.Simulator == "US"))
    {
        CSVWriter CSVFolder("", "");
    ...
    if ((this->args.OutFl) && (this->args.AllowCROS) && (this->args.Simulator == "S" || this->args.Simulator == "US"))
    {
        CSVWriter CSVFolder("", "");
    ...
    */
    ...
    if (this->args.WeatherOpt.compare("mc") == 0)
    {
        // Sampled Weather
        this->CSVWeather.fileName
            = this->args.InFolder + "Weathers" + separator() + "Weather" + std::to_string(mcnumber) + ".csv";
...
#pragma omp for
        for (ep = 1; ep <= args.TotalSims; ep++)
        {
            ...
            // Reset
            Forest.reset(rnumber, rnumber2, args.mcnumber, ep);
