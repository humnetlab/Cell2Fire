...
initialize_coeff(int scenario)
{
    if (scenario == 1)
    {
        ...
        p_coeff.insert(std::make_pair(F0, p_0));
        q_coeff.insert(std::make_pair(F0, q_0));

        // FM 91
        int F91 = 91;
        std::vector<float> p_91;
        p_91.push_back(0);
        p_91.push_back(0);
        p_91.push_back(0);

        std::vector<float> q_91;
        q_91.push_back(0);
        q_91.push_back(0);
        q_91.push_back(0);

        p_coeff.insert(std::make_pair(F91, p_91));
        q_coeff.insert(std::make_pair(F91, q_91));

        // FM 92
        int F92 = 92;
        std::vector<float> p_92;
        p_92.push_back(0);
        p_92.push_back(0);
        p_92.push_back(0);

        std::vector<float> q_92;
        q_92.push_back(0);
        q_92.push_back(0);
        q_92.push_back(0);

        p_coeff.insert(std::make_pair(F92, p_92));
        q_coeff.insert(std::make_pair(F92, q_92)); 

        // FM 93
        int F93 = 93;
        std::vector<float> p_93;
        p_93.push_back(0);
        p_93.push_back(0);
        p_93.push_back(0);

        std::vector<float> q_93;
        q_93.push_back(0);
        q_93.push_back(0);
        q_93.push_back(0);

        p_coeff.insert(std::make_pair(F93, p_93));
        q_coeff.insert(std::make_pair(F93, q_93)); 

        // FM 98
        int F98 = 98;
        std::vector<float> p_98;
        p_98.push_back(0);
        p_98.push_back(0);
        p_98.push_back(0);

        std::vector<float> q_98;
        q_98.push_back(0);
        q_98.push_back(0);
        q_98.push_back(0);

        p_coeff.insert(std::make_pair(F98, p_98));
        q_coeff.insert(std::make_pair(F98, q_98)); 

        // FM 99
        int F99 = 99;
        std::vector<float> p_99;
        p_99.push_back(0);
        p_99.push_back(0);
        p_99.push_back(0);

        std::vector<float> q_99;
        q_99.push_back(0);
        q_99.push_back(0);
        q_99.push_back(0);

        p_coeff.insert(std::make_pair(F99, p_99));
        q_coeff.insert(std::make_pair(F99, q_99)); 
        ...
        // FM 141 (DUMMY)
        int F141 = 141;
        std::vector<float> p_141;
        p_141.push_back(0.3505);
        p_141.push_back(0.07768);
        p_141.push_back(0.01498);

        std::vector<float> q_141;
        q_141.push_back(-1.959);
        q_141.push_back(0.0322);
        q_141.push_back(2.819);

        p_coeff.insert(std::make_pair(F141, p_141));
        q_coeff.insert(std::make_pair(F141, q_141));
        ...
        // FM 184 (DUMMY)
        int F184 = 184;
        std::vector<float> p_184;
        p_184.push_back(2.195);
        p_184.push_back(0.1807);
        p_184.push_back(0.07939);

        std::vector<float> q_184;
        q_184.push_back(-0.8838);
        q_184.push_back(0.08234);
        q_184.push_back(1.368);

        p_coeff.insert(std::make_pair(F184, p_184));
        q_coeff.insert(std::make_pair(F184, q_184));
        ...
        // FM 187 (DUMMY)
        int F187 = 187;
        std::vector<float> p_187;
        p_187.push_back(10.09);
        p_187.push_back(0.3454);
        p_187.push_back(0.584);

        std::vector<float> q_187;
        q_187.push_back(-0.4398);
        q_187.push_back(0.1448);
        q_187.push_back(0.7804);

        p_coeff.insert(std::make_pair(F187, p_187));
        q_coeff.insert(std::make_pair(F187, q_187));
    ...
    if (scenario == 2)
    {
        ...
        int F141 = 141;
        std::vector<float> p_141;
        p_141.push_back(3.016);
        p_141.push_back(0.1405);
        p_141.push_back(0.117);

        std::vector<float> q_141;
        q_141.push_back(-0.8923);
        q_141.push_back(0.06068);
        q_141.push_back(1.351);
        ...
        int F184 = 184;
        std::vector<float> p_184;
        p_184.push_back(16.14);
        p_184.push_back(0.4104);
        p_184.push_back(0.9961);

        std::vector<float> q_184;
        q_184.push_back(-0.3704);
        q_184.push_back(0.2021);
        q_184.push_back(0.6365);
        ...
        q_coeff.insert(std::make_pair(F186, q_186));
		  ...
		  int F187 = 187;
		  std::vector<float> p_187;
		  p_187.push_back(16.14);
		  p_187.push_back(0.4104);
		  p_187.push_back(0.9961);

		  std::vector<float> q_187;
		  q_187.push_back(-0.3704);
		  q_187.push_back(0.2021);
		  q_187.push_back(0.6365);
    ...
    if (scenario == 3)
    {
        ...
        int F141 = 141;
        std::vector<float> p_141;
        p_141.push_back(10.39);
        p_141.push_back(0.2182);
        p_141.push_back(0.3807);

        std::vector<float> q_141;
        q_141.push_back(-0.5648);
        q_141.push_back(0.1069);
        q_141.push_back(0.9037);
        ...
        int F184 = 184;
        std::vector<float> p_184;
        p_184.push_back(5.163);
        p_184.push_back(0.2396);
        p_184.push_back(0.1943);

        std::vector<float> q_184;
        q_184.push_back(-0.6817);
        q_184.push_back(0.1007);
        q_184.push_back(1.064);
        ...
        int F187 = 187;
        std::vector<float> p_187;
        p_187.push_back(11.37);
        p_187.push_back(0.3397);
        p_187.push_back(1.244);

        std::vector<float> q_187;
        q_187.push_back(-0.3582);
        q_187.push_back(0.1543);
        q_187.push_back(0.6369);
    ...
    if (scenario == 4)
    {
        ...
        int F141 = 141;
        std::vector<float> p_141;
        p_141.push_back(23.95);
        p_141.push_back(0.3007);
        p_141.push_back(0.9045);

        std::vector<float> q_141;
        q_141.push_back(-0.4438);
        q_141.push_back(0.1155);
        q_141.push_back(0.7152);
        ...
        int F184 = 184;
        std::vector<float> p_184;
        p_184.push_back(5.518);
        p_184.push_back(0.2432);
        p_184.push_back(0.2307);

        std::vector<float> q_184;
        q_184.push_back(-0.6166);
        q_184.push_back(0.1085);
        q_184.push_back(1.011);
        ...
        int F187 = 187;
        std::vector<float> p_187;
        p_187.push_back(19.31);
        p_187.push_back(0.4546);
        p_187.push_back(1.428);

        std::vector<float> q_187;
        q_187.push_back(-0.2634);
        q_187.push_back(0.2268);
        q_187.push_back(0.55);
            ...
            bool& activeCrown)
{
    ...
    // std::cout << "Fire Scenario: " << args->scenario << std::endl;
