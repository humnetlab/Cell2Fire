...
def GenerateDat(GFuelType, GFuelTypeN, Elevation, PS, SAZ, Curing, CBD, CBH, CCF, InFolder):
    # DF columns
    Columns = ["fueltype", "lat", "lon", "elev", "ws", "waz", "ps", "saz", "cur", "cbd", "cbh", "ccf"]
...
def GenDataFile(InFolder):
    ...
    Elevation, SAZ, PS, Curing, CBD, CBH, CCF = DataGrids(InFolder, NCells)
    GenerateDat(GFuelType, GFuelTypeN, Elevation, PS, SAZ, Curing, CBD, CBH, CCF, InFolder)